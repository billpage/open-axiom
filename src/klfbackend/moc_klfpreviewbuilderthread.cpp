...
static const char qt_meta_stringdata_KLFPreviewBuilderThread[] = {
    "KLFPreviewBuilderThread\0\0preview,latexerror\0"
    "previewAvailable(QImage,bool)\0bool\0"
    "input\0inputChanged(KLFBackend::klfInput)\0"
    "settings\0settingsChanged(KLFBackend::klfSettings)\0"
};
...
const QMetaObjectExtraData KLFPreviewBuilderThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject KLFPreviewBuilderThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_KLFPreviewBuilderThread,
      qt_meta_data_KLFPreviewBuilderThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &KLFPreviewBuilderThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_KLFPreviewBuilderThread))
